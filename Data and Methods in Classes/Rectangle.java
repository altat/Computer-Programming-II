...
public class Rectangle extends Shape {
	...
	//data items here
	int x,y,x2,y2;  //what should these be? public? private? -These should be private
					// These are 4 instance variables
	...
	//do static methods then have any concept of 'this'? -No because 'this' refers to a target object and there is no
	//													  target object instance when you call a static method.
	public static boolean isEquals(Rectangle one, Rectangle two) {
		...
		return retVal; // 'retVal' is a local variable
	}
	...
	public boolean equals(Object other) {
		...
		Rectangle theOther = (Rectangle) other; // I think 'theOther' is a local reference variable
	...
	public double getArea() {
		return (this.x2 - this.x) * (this.y2 - this.y);  //what goes here?
														 //This method should multiply the rectangle's length and width
														 //to get area. It can find width by subtracting x2 and x and
														 //it can find length by subtracting y2 and y.
	}
