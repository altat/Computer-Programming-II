...
public class Money implements Comparable, Cloneable, Serializable {
     ...
     * @return returns 0 if the Money amounts are the same. returns a positive
     * number if this amount is greater than that amount. returns -1 otherwise.
     */
    @Override
     ...
     * @return returns a deep copy of this Money
     */
    @Override
    public Money clone(){
        Money clone = new Money(this.dollars, this.cents);
        return clone;
    }
    ...
    @param dol: int value for setting dollars
    @param cent: int value for setting cents
     */
    ...
    */
    ...
    @param cents: int value to set cents to
    @Pre True
