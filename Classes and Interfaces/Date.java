...
public class Date implements Comparable, Cloneable, Serializable {
     ...
     * @return returns 0 if the dates are the same. returns a positive number
     * if this date is greater than that date. returns -1 otherwise.
     */
    @Override
     ...
     * @return returns a deep copy of this Date
     */
    @Override
    public Date clone() {
        Date clone = new Date(this.month, this.day, this.year);
        return clone;
    }

    /**
    Constructor that sets the month, day and year. Does not accept invalid values
    @param month: a number representation of month (1-12)
    @param day: a number representation of day (1-31)
    @param year: a number representation of year (2014-2024)
    */
    ...
    */
    ...
    @param year: 4 digit year (2014-2024)
    @Pre TRUE
    ...
    @param month: 1 or 2 digit month (1-12 or 01-12)
    @Pre TRUE
    ...
    @param day: 1 or 2 digit day  (1-31 or 01-31)
    @Pre TRUE
    ...
    @param compareTo: the date to compare this with
    @Pre TRUE
